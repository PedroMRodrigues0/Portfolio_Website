          ...
          <div className="ContentContainer grid md:grid-cols-2">
            <div className="LeftContainer flex flex-col px-10 lg:pl-20 col-span-1 max-lg:col-span-2 justify-center">
              ...
              <div className="ContactContainer">
                <h2 className=" font-normal text-2xl max-md:text-xl font-manrope text-zinc-200 ml-1 mt-8">
                  Contact me and see my work
                </h2>
                <div className="ContactInfo flex flex-col gap-y-5">
                  <div className="Github flex flex-row items-center gap-2 mt-4">
                    <svg
                      fill="#FFFFFF"
                  ...
                  <div className="Linkedin flex flex-row items-center gap-2 ">
                    ...
                    <a
                      className=" text-zinc-200 ml-1"
                      href="http://www.linkedin.com/in/pedromateus0"
                    >
                      Linkedin
                    </a>
                  </div>
                  <div className="Gmail flex flex-row items-center gap-2">
                    <svg
                      className=" ml-[2px]"
                      fill="#FFFFFF"
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <h3 className=" text-zinc-200 ml-1">
                      pedromgrodrigues0@gmail.com
                    </h3>
                  </div>
                </div>
              </div>
