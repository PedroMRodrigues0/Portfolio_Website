...
export const PinPerspective = ({
  ...
  return (
    <motion.div
      className="pointer-events-none max-sm:w-60  w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500"
      animate={{ opacity: isVisible ? 1 : 0 }}
    >
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <div className="relative flex space-x-2 items-center max-sm:top-4 z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
        ...
        >
          <>
            ...
            <motion.div
              ...
              className="absolute  left-1/2 right-8 top-1/2  h-[11.25rem] w-[11.25rem] rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            ></motion.div>
          </>
        </div>

        <>
          <motion.div className="absolute   right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-zinc-900 translate-y-[14px] w-px h-20 group-hover/pin:h-40 blur-[2px]" />
          <motion.div className="absolute   right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-zinc-300 translate-y-[14px] w-px h-20 group-hover/pin:h-40  " />
          ...
          <motion.div className="absolute   right-1/2 translate-x-[0.5px] bottom-1/2 bg-zinc-400 translate-y-[14px] w-[2px] h-[2px] rounded-full z-40 " />
        </>
      </div>
    </motion.div>
  );
